...
<body>
	<div class="jumbotron text-center">
		<font size="7">Bank of America</font>
	...
	<div class="container">
		<h2>Transfer</h2>
		<form action="/BankAppSpringWebMVC/app/bankapp/transfer" method="post">
			<div class="form-group">
				<label for="FAccNo">From Account No:</label> <input type="number"
					class="form-control" id="FAccNo" name="FAccNo">
			</div>
			<div class="form-group">
				<label for="TAccNo">To Account No:</label> <input type="number"
					class="form-control" id="TAccNo" name="TAccNo">
			</div>
			<div class="form-group">
				<label for="Amt">Amount:</label> <input type="number"
					class="form-control" id="Amt" name="Amt">
			</div>
			<center>
